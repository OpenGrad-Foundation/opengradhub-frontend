...
export default function AssessmentsPage() {
  ...
  // Students only see assessments if PG
  const isStudentWithoutAccess = roleCode === "STUDENT" && programmeType !== "PG";

  if (!ALLOWED_ROLES.includes(roleCode) || isStudentWithoutAccess) {
    return (
      <div style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{
          ...
          <p style={{ marginTop: "8px", fontSize: "14px", color: "rgba(3,72,82,0.6)" }}>
            {roleCode === "STUDENT"
              ? "Assessments are only available for PG programme students."
    ...
    <div>
      <div style={{
        ...
        <p style={{ marginTop: "6px", fontSize: "14px", color: "rgba(3,72,82,0.6)" }}>
          PG programme assessments and practice tests.
        </p>
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: "18px", fontWeight: 700, color: "#034852" }}>
          Assessments module is under construction
        </p>
        <p style={{ marginTop: "8px", fontSize: "14px", color: "rgba(3,72,82,0.6)", maxWidth: "480px", margin: "8px auto 0" }}>
          Mock tests, quizzes, and timed assessments for PG students will appear here.
        </p>
      </div>
    </div>
  );
